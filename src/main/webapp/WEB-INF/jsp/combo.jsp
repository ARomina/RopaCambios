							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="shop-menu">
									<ul class="nav navbar-nav">
										...
										<li><a href="/ropa2/verListaDeseos"><i class="fa fa-star"></i> Wishlist</a></li>
...
<% if (session.getAttribute("user") != null){%>
										<li><a href="/ropa2/logout"><i class="fa fa-sign-out" >
	...
	<div class="modal-dialog">
      <div class="modal-content modal-agregar">
        ...
        <div class="modal-body">
			<form:form action="/ropa2/login" modelAttribute="usuario" role="form" method="POST" name="login" >
			  ...
			  <div class="form-group">
				...
				<div class="modal-footer">	
					<a href="/ropa2/registro">¿No tenés cuenta? Registrate </a>
